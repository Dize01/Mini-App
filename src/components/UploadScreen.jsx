...
export default function UploadScreen({ onFileSelect, color = 'blue' }) {
  const btnClass = COLORS[color] ?? COLORS.blue;
    ...
    <div>
      ...
      >
        ...
        <label className="cursor-pointer">
          ...
          />
          <span className={`${btnClass} text-white px-6 py-2.5 rounded-xl transition-colors text-sm font-semibold inline-block`}>
            Choose PDF
          </span>
        </label>
      </div>
